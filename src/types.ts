...
export interface ClockWeatherCardConfig extends LovelaceCardConfig {
  ...
  /**
   * Proprietà aggiunta per gestire il comportamento al clic (tap) sulla card.
   * Esempi di possibili `action`: "more-info", "navigate", "call-service".
   */
...
export interface MergedClockWeatherCardConfig extends LovelaceCardConfig {
  ...
  /**
   * Deve essere presente anche qui, altrimenti TypeScript segnalerà l’errore
   * "La proprietà 'tap_action' non esiste nel tipo 'MergedClockWeatherCardConfig'".
   */
  tap_action?: ActionConfig
}
